...
export default function AboutUs (){
    return(
        <div className="about-container">
            <h1>Our History</h1>
            <p>Trippy is owned and managed by Trippy in Pvt. Ltd, a leading brand in web designing services and e-commerce solutions. Trippy in Pvt. ltd. is counted for its expertise in web solutions and its top ranking business portol. Our invincible exportise and rich exporiance has raisad our spirit to reach ahead from our client's expectation. Commendable success rote of other portals managed by Trippy is a live paradigm of our work excellence.</p>
